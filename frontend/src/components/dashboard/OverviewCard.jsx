  ...
  <section className="rounded-3xl bg-emerald-100/60 p-6 shadow-lg ring-1 ring-emerald-100 md:p-8">
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-full bg-emerald-600 text-2xl font-bold text-white shadow-lg shadow-emerald-200">
          {user?.avatarUrl ? (
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <StatCard icon={statsIcons.registered} label="Registered" value={stats.registered} colorClass="text-cyan-600" bgClass="bg-cyan-50" />
